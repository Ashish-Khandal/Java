...
public class ReferenceVar {
    public static void main(String[] args) {
        ...
        //Define
        //! object(referance variable).getClass().getName()
        ...
        //! if variable is referance variable then output this type code [I@hexadecimal
        // or [classname@hashcode inhexadecimal .
